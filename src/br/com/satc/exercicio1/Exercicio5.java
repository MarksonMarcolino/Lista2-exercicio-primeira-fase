...
public class Exercicio5 {
    ...
    public static void main(String[] args) {
        ...
        double porcsncand1 = (voto1 * 100) / ncand;
        double porcsncand2 = (voto2 * 100) / ncand;
        double porcsncand3 = (voto3 * 100) / ncand;
        double porcsncand4 = (voto4 * 100) / ncand;
        double porcsncandn = (voton * 100) / ncand;
        double porcsncandb = (votob * 100) / ncand;
